...
class OutputConfig:
    ...
    def __init__(self,
        ...
        Args:
            ...
            converter (str, optional): The pdf converter to use. Can be "libreoffice", "officetopdf" or any custom defined converter. Custom converters are configurated in the AOP server's `aop_config.json` file. Defaults to "libreoffice".
