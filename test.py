...
async def test_async():
    ...
    imageElement = cop.elements.Image.from_file(
        "imageTag", "./tests/data/test.jpg")
    imageElement.max_width = 500
    imageElement.rotation = 75
    data1.add(imageElement)

    data2 = cop.elements.ElementCollection()
    data2.add(cop.elements.ElementCollection.from_mapping({
        "textTag1": "Hello",
        "textTag2": ", ",
        "textTag3": "world",
        "textTag4": "!"
...
if __name__ == "__main__":
    ...
    #   because they send the template and data to an Cloud Office Print server and then save its response.
